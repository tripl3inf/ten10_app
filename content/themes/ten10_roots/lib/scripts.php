...
function roots_scripts() {
  ...
  if (WP_ENV === 'development') {
    $assets = array(
      ...
      'rangeslider_css' => '/assets/vendor/rangeslider.js/dist/rangeslider.css',
      'css'       => '/assets/css/main.css',
      'js'        => '/assets/js/scripts.js',
      'modernizr' => '/assets/vendor/modernizr/modernizr.js',
      'jquery'    => '//ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.js',
      'bootstrap' => '/assets/vendor/bootstrap/dist/js/bootstrap.min.js',
      'rangeslider_js' => '/assets/vendor/rangeslider.js/dist/rangeslider.js',
...
//  wp_enqueue_style('rangeslider_css', get_template_directory_uri() . $assets['rangeslider_css'], false, null);
  ...
  wp_enqueue_script('rangeslider_js', get_template_directory_uri() . $assets['rangeslider_js'], false, null);
