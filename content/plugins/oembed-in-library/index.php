...
class OEmbedInLibrary {
    ...
    public function admin_menu() {
        add_submenu_page("upload.php", __('Embed in Library', 'oembed-in-library'), __('oEmbed', 'oembed-in-library'), 'upload_files', 'oembedinlibrary', array($this, 'page_embed'));
    ...
    public function add_in_library() {
        ...
        if($provider === false) {
            $_SESSION['oembed_in_library']['errors'][] = __('No provider found for this URL.', 'oembed-in-library') . '</a>';
